    ...
    <>
      ...
      <div className="max-w-5xl mx-auto py-12 px-4 text-gray-800">
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl shadow p-8 mb-10 text-center">
          <h1 className="text-4xl font-bold mb-2 text-blue-900">About Laptop House</h1>
        ...
        <Card className="mb-8 shadow-lg">
          ...
          <CardContent>
            <p className="mb-4">
              Founded in 2022, Laptop House was born out of a passion for technology and a commitment to making high-quality laptops and accessories accessible to everyone in India. We believe in honest pricing, transparent policies, and exceptional customer service.
            </p>
            <p>
        ...
        <Card className="shadow-md mb-8">
          <CardHeader className="flex items-center gap-2">
            ...
            <CardTitle className="text-lg">Join the Laptop House Family</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        {/* <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex gap-6">
            <a href="https://facebook.com/Laptop House" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            ...
            <a href="https://twitter.com/Laptop House" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
            ...
            <a href="https://instagram.com/Laptop House" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <a href="https://linkedin.com/company/Laptop House" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            ...
            <a href="https://youtube.com/@Laptop House" target="_blank" rel="noopener noreferrer" aria-label="YouTube">

...
export default function AffiliatePage() {
  return (
    <div className="max-w-2xl mx-auto py-12 px-4 text-gray-800">
      ...
      <p className="mb-4">Earn with Laptop House by joining our affiliate program!</p>
      <ul className="list-disc ml-6 mb-4">
        <li>Attractive commissions on every sale</li>
        <li>Easy tracking and timely payouts</li>
        <li>Sign up by emailing <a href="mailto:affiliate@Laptop House.com" className="text-blue-600 underline">affiliate@Laptop House.com</a></li>
      </ul>

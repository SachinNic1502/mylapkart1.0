...
export default function CareersPage() {
  return (
    <div className="max-w-2xl mx-auto py-12 px-4 text-gray-800">
      <h1 className="text-3xl font-bold mb-6">Careers at Laptop House</h1>
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li>Send your resume to <a href="mailto:hr@Laptop House.com" className="text-blue-600 underline">hr@Laptop House.com</a></li>
      </ul>
